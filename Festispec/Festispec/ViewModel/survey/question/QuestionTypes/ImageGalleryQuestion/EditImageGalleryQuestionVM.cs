...
{
    public class EditImageGalleryQuestionVM : ViewModelBase
    {
        ...
        public EditImageGalleryQuestionVM()
        {
            ...
            {
                if (message.NextQuestion.GetType() == typeof(ImageGalleryQuestionVM))
                {
                    _surveyVm = message.SurveyVM;
                    QuestionVm = (ImageGalleryQuestionVM)message.NextQuestion;
